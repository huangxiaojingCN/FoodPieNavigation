    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "showRestaurantDetail" {
            if let indexPath = tableView.indexPathForSelectedRow {
                ...
                destinationViewController.restaurantName = self.restaurantNames[indexPath.row]
                destinationViewController.restaurantLocation = self.restaurantLocations[indexPath.row]
                destinationViewController.restaurantType = self.restaurantTypes[indexPath.row]
            }
        }
    }
